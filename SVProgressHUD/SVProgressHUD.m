...
- (void)updateHUDFrame {
    ...
    if(self.statusLabel.text) {
        CGFloat maximumWidth = MIN(320, UIScreen.mainScreen.bounds.size.width - 28 * 2) - SVProgressHUDHorizontalSpacing * 2;
        CGSize constraintSize = CGSizeMake(maximumWidth, 300.0f);
